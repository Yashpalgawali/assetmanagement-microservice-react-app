...
export default function ViewAssetTypeComponent() {
    ...
    const filteredAssetTypes = assetTypeList.filter(type =>
        type.assetType.toLowerCase().includes(searchTerm.toLowerCase())
    );
            ...
            >
                <Box>
                    ...
                    <Typography variant="subtitle1" sx={{ opacity: 0.8 }}>
                        Organize and classify company assets for better tracking
                    </Typography>
                </Box>
                <Button
                    variant="contained"
                        ...
                        {filteredAssetTypes.length > 0 ? (
                                ...
                                >
                                    ...
                                    <TableCell align="center">
                                        <Tooltip title="Edit Category">
                                            <IconButton
                                                color="primary"
                                                onClick={() => navigate(`/assettype/${type.assetTypeId}`)}
                                                sx={{
                            ...
                            <TableRow>
                                <TableCell colSpan={3} align="center" sx={{ py: 10 }}>
                                    <Box sx={{ opacity: 0.5 }}>
                                        <CategoryIcon sx={{ fontSize: 64, mb: 1, color: 'text.disabled' }} />
                                        <Typography variant="h6">No categories found</Typography>
                                        <Typography variant="body2">Try adjusting your search criteria or add a new category</Typography>
                                    </Box>
                                </TableCell>
                            </TableRow>
                        )}
